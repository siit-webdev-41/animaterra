...
export default [
  ...
  new Card("Armura Magică", 15, "Cu mine ești de neatins!", `green`),
  new Card("Podul Ștrengar", 16, "Ai curaj să fii diferit și vei descoperi puteri nebănuite în tine.", `gold`),
  ...
  new Card("Portalul dintre lumi", 2, "Ai curaj să treci portalul și să te lupți cu întunericul?", `gold`),
  ...
  new Card("Făt Frumos în luptă cu Zmeul", 20, "Nu voi lăsa lumina să pice pradă întunericului! Vei pierde, Făt Frumos, putere ca a mea nu are nimeni.", `purple`),
  new Card("Dihorul Pătat", 3, "Vârtej îmi spun prietenii, iar calitatea mea preferată este că zâmbesc de fiecare dată.", `blue`),
  new Card("Barbă Lungă Stat Mărunt", 5, "Muntele se mută din loc în fața viteazului neînfricat.", `purple`),
  new Card("Lia", 5, "Neînfricată m-am născut. Părinții mei puteri nebănuite mi-au țesut.", `blue`),
  new Card("Scânteie", 13, "Din soare îmi iau energie și pe pământ mă joc cu magia.", `teal`),
  ...
  new Card("Soarele", 17, "Lumina mea interioară este în fiecare dintre voi. Lăsați-o să strălucească.", `teal`),
  new Card("Luna", 7, "Din fața nevăzută îmi vine misterul, dar care este forța mea?", `teal`),
  ...
  new Card("Busola Posibilităților", 19, "Ești cuantic, în superpoziție.", `gold`),
  ...
  new Card("Soarele și Luna", 21, "Lumina ta îmi bucură sufletul. Calmul tău îmi limpezește mintea.", `teal`),
  ...
  new Card("Diana Iana Ziana", 10, "Să nu te îndoiești de zânele bune chiar și atunci când nu le înțelegi acțiunile.", `purple`),
